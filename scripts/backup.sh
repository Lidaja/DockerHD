...
EOF
  ...
  #network_vip6=(10.10.30.230)
  #network_vip=(10.10.30.230)
  vip=${network_vip[0]}
  vip6=${network_vip6[0]}
  for i in $(seq 1 ${node_count}); do
  ...
  for i in $(seq 1 ${node_count}); do
    ...
    docker exec vipr$i /opt/ADG/conf/configure.sh installNetworkConfigurationFile 1 10.10.30.1 255.255.255.0 10.10.30.231 10.10.30.235
